...
const SelectedCityEx = (props) => {
    ...
    return(
        ...
        display:"flex",flexDirection: "column"}}>
            ...
            <StackedBar thisCity={props.thisCity} title={"Sudedamosios rodiklio dalys 2020 metais"} seterHover={props.seterHover}></StackedBar>
            <hr className="" style={dividerStyle}></hr>
...
const FourIcons = (props) => {
    ...
    const style1 = {position:"absolute", marginLeft:"10px", marginTop:"0px"}
    const style2 = {}
    ...
    datasets: [
      {
        ...
        data: data.y,
        fill: false,
        backgroundColor: 'rgb(244,104,136, 0.7)',
        borderColor: 'rgb(244,104,136, 0.7)',
        borderWidth: '3',
      },
    ],
  };
