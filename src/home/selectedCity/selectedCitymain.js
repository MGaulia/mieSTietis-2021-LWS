...
const SelectedCityMain = (props) => {
    ...
    const [param, setParams] = useState("vanduo")
    useEffect(()=>{
        setCity(props.thisCity)
    })
    const changeParam = (par) =>{
        setParams(par)
    }
...
const Apibud = (props) => {
    const [group, setGroup] = useState(props.param)
...
const FourIcons = (props) => {
        ...
        fetch(
            "http://127.0.0.1:5000/transportas_change")
                        ...
                        .then((json) => {
                          ...
                          console.log("AASASASSAAS",json[miestas][0])
                        })
    ...
    const style1 = {}
    const style2 = {fontSize:"25px", paddingLeft: "10px"}
    const style3= {marginLeft:"5px"}
    return(
    <div>
        <div className="row">
            <div className="col col-6" onClick={()=>props.changeParam("vanduo")}>
                ...
                <span style={{ paddingLeft:"5px", color:(vanduo.y_change>0)?"green":"red"}}>
                    {vanduo.y_change}%
                </span>

                </div>
            </div>
            <div className="col col-6" onClick={()=>props.changeParam("oras")}>
                <div>
                    Oro taršos rodiklis
                </div>
                <div>
                ...
                <span style={{paddingLeft:"5px", color:(oras.y_change>0)?"green":"red"}}>
                    {oras.y_change}%
                </span>
                </div>
        ...
        <div className="row">
        <div className="col col-6" onClick={()=>props.changeParam("tranportas")}>
            <div style={{paddingLeft:"3px"}}>
                Transporto rodiklis
            </div>
                <div>
                ...
                <span style={style2}>
                    {tranportas.y_lastyear}
                </span>
                

                <span style={{paddingLeft:"5px", color:(tranportas.y_change>0)?"green":"red"}}>
                    {tranportas.y_change}%
                </span>
                </div>
            </div>
            <div className="col col-6" onClick={()=>props.changeParam("siuksles")}>
                <div>Atliekų rodiklis</div >
                <div>
                <span>
                ...
                <span style={{paddingLeft:"5px", color:(siuksles.y_change>0)?"green":"red"}}>
                    {siuksles.y_change}%
                </span>
                </div>
            </div>
    ...
    return(
        <div style={{padding:"10px"}}>
            ...
            <span style={{padding: "5px"}}>
                pagal kovos su klimato kaita rodiklį
            </span>
        </div>
    )
}
